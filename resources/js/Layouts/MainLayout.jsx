    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-800 selection:bg-blue-600 selection:text-white">
            ...
            <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-3' : 'bg-transparent py-5'}`}>
                ...
                {isMobileMenuOpen && (
                    <div className="fixed inset-0 z-[100] bg-gray-900/95 backdrop-blur-md text-white flex flex-col items-center justify-center md:hidden transition-opacity duration-300">
                        <button 
                        ...
                        <div className="flex flex-col items-center space-y-8 text-2xl font-bold w-full px-6">
                            <Link href="/" className="hover:text-blue-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Home</Link>
                            <Link href="/about" className="hover:text-blue-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>About Us</Link>
                            <Link href="/products" className="hover:text-blue-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Services</Link>
                            <Link href="/events" className="hover:text-blue-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Events</Link>
                            <Link href="/contact" className="hover:text-blue-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Contact</Link>
                            <div className="pt-8 mt-4 border-t border-gray-700 w-full flex justify-center">
                                <Link href="/login" className="px-10 py-3 rounded-full font-semibold bg-blue-600 text-white hover:bg-blue-500 shadow-lg transition-all" onClick={() => setIsMobileMenuOpen(false)}>
                                    <FontAwesomeIcon icon={faRightToBracket} className="mr-2" /> Login Area
                                </Link>
                            </div>
                        </div>
                    </div>
